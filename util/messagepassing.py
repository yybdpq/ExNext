...
from torch_geometric.nn.conv.utils.typing import parse_types, resolve_types, sanitize, split_types_repr
    ...
    def propagate(self, edge_index: Adj, size: Size = None, **kwargs):
        ...
        if is_sparse(edge_index) and self.fuse and not self.explain:
            ...
            for i in range(decomposed_layers):
                ...
                out, attention_scores, attn_output_weights = self.message(**msg_kwargs)        #message!
